...
class Model:
    ...
    def addEdgesV1(self):
        ...
        for c in allConnessioni:
            ...
            v1 = c.v1
            peso = c.N
            if v0 in self._grafo.nodes and v1 in self._grafo.nodes:
    ...
    def addEdgesV2(self):
        ...
        for c in allConnessioni:
            if c.v0 in self._grafo.nodes and c.v1 in self._grafo.nodes:
    ...
    def _ricorsione(self, parziale, target, t):
        ...
        # Verificare se parziale è meglio di best e in caso esco
        if len(parziale) == t+1:
            return
